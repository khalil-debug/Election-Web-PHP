...
<html>
 ...
 <body>
    ...
    <section id="section"> 
    	<article>
            <h1><img src="images/ico_epingle.png" alt="icone" class="Description" /> Description </h1>
             <p>Ceci est le site d'élections fictives en ligne, permettant à des électeurs anonymes d'élire les membres du parlement. un électeur pourra à tout moment retirer son vote ou le modifier. il pourra aussi à tout moment afficher les résultat instantannée des élections qui prennent en compte tous les électeurs sur le web.</p>
    	</article>
